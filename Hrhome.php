...
<body>
	<div class="Menu">
        ...
        {
            echo '<a style="float: right" href="logout.php"><span class="glyphicon glyphicon-off"></span></a>
                    <a style="float: right" href="userProfile.php" ><span class="glyphicon glyphicon-user"></span> '. $_SESSION["username"] . '</a>';
        }
        else
        {
